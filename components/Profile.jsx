...
export default function Profile() {
  return (
    <div className="min-h-screen p-5 bg-gray-50">
            <h2 className="text-2xl md:text-3xl font-bold text-indigo-500 mb-6 text-center">
              My Profile
            </h2>
        ...
        <div className="flex flex-wrap md:flex-nowrap">
          ...
          <div className="info-box w-full p-6 md:p-8">
            ...
            <div className="border-b py-5">
              ...
              <div className="flex flex-wrap">
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Full Name:</span> <span className="text-gray-500">Safwat Bilal</span> 
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Gender:</span> <span className="text-gray-500">Male</span> 
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Country:</span> <span className="text-gray-500">Syria</span> 
                </div>
              </div>
            </div>
            <div className="border-b py-5 mt-6">
              ...
              <div className="flex flex-wrap">
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Email:</span> <span className="text-gray-500">safwetbilal65@gmail.com</span> 
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Phone:</span> <span className="text-gray-500"> (+963) 943860752</span> 
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Date Of Birth:</span>  <span className="text-gray-500">06/06/2003</span> 
                </div>
              </div>
            </div>
            ...
            <div className="border-b py-5 mt-6">
              ...
              <div className="flex flex-wrap">
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Title:</span>   <span className="text-gray-500">Frontend Developer</span> 
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Programming Language:</span> <span className="text-gray-500">React js </span> 
                  and Next js
                </div>
                <div className="text-sm md:text-base w-full sm:w-1/2 lg:w-1/3 mb-3">
                  <span className="font-semibold text-gray-700">Years Of Experience:</span>  <span className="text-gray-500">1.5+ </span> 
                </div>
              </div>
            </div>
          </div>
